...
$arResult = null;
    ...
    $arFilter = array("IBLOCK_ID" => 5, "ACTIVE_DATE" => "Y", "ACTIVE" => "Y", "PROPERTY_CML2_ARTICLE" => strval($artnumber));
    ...
    while ($ob = $res->GetNextElement()) {
        ...
        $r = '<tr data-artnumber = "'.$ar_res['PROPERTIES']['CML2_ARTICLE']['VALUE'].'" data-id = "' . $ar_res['PRODUCT']['ID'] . '" data-price = "' . $price . '">
