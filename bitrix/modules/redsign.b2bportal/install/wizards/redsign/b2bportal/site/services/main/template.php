...
if (!in_array($wizrdTemplateId, array("b2bportal")))
	$wizrdTemplateId = "b2bportal";

COption::SetOptionString("main", "wizard_template_id", $wizrdTemplateId, false, WIZARD_SITE_ID);

function ___writeToAreasFile(string $fn, string $text): void
{
	$fd = @fopen($fn, "wb");
	if (!$fd)
		return;
...
if ($logo || $logoRetina) {
	...
	___writeToAreasFile(WIZARD_SITE_PATH . "include/logo.php", $content);
}
elseif(WIZARD_INSTALL_DEMO_DATA || !file_exists(WIZARD_SITE_PATH . "/include/logo.php") && !file_exists(WIZARD_SITE_PATH . "/include/logo.png")) {
	copy(WIZARD_ABSOLUTE_PATH . "/site/templates/b2bportal/themes/" . $themeID . "/images/logo.png", WIZARD_SITE_PATH . "include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH . "/site/templates/b2bportal/themes/" . $themeID . "/images/logo_retina.png", WIZARD_SITE_PATH . "include/logo_retina.png");
	___writeToAreasFile(WIZARD_SITE_PATH . "include/logo.php", '<img src="' . WIZARD_SITE_DIR . 'include/logo.png" srcset="' . WIZARD_SITE_DIR . 'include/logo_retina.png 2x" />');
}
...
if($logoMobile || $logoMobileRetina)
{
	if ($logoMobile)
	{
		...
		@copy($strOldFile, WIZARD_SITE_PATH . "include/logo_color.png");
	...
	if($logoMobileRetina)
	{
		...
		@copy($strOldFile, WIZARD_SITE_PATH . "include/logo_color_retina.png");
		CFile::Delete($fLogoMobileRetina);
	}

	$retinaPath = file_exists(WIZARD_SITE_ROOT_PATH . "include/logo_color_retina.png") ? WIZARD_SITE_PATH . "include/logo_color_retina.png" : "";
	$content = '<img src="' . WIZARD_SITE_DIR . 'include/logo_color.png"' . ($retinaPath ? ' srcset="' . $retinaPath . ' 2x"' : "") . '/>';
	___writeToAreasFile(WIZARD_SITE_PATH . "include/logo_colors.php", $content);
}
elseif(WIZARD_INSTALL_DEMO_DATA || !file_exists(WIZARD_SITE_PATH . "/include/logo_colors.php") && !file_exists(WIZARD_SITE_PATH . "/include/logo_mobile.png") /*|| __isDefaultLogoOrText(WIZARD_SITE_PATH . "/include/company_name.php")*/)
{
	copy(WIZARD_ABSOLUTE_PATH . "/site/templates/b2bportal/themes/" . $themeID . "/images/logo_mobile.png", WIZARD_SITE_PATH . "include/logo_color.png");
	copy(WIZARD_ABSOLUTE_PATH . "/site/templates/b2bportal/themes/" . $themeID . "/images/logo_mobile_retina.png", WIZARD_SITE_PATH . "include/logo_color_retina.png");
	___writeToAreasFile(WIZARD_SITE_PATH . "include/logo_colors.php", '<img src="' . WIZARD_SITE_DIR . 'include/logo_color.png" srcset="' . WIZARD_SITE_DIR . 'include/logo_color_retina.png 2x" />');
}
