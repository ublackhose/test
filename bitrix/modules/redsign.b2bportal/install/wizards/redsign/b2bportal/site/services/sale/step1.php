...
COption::SetOptionString("redsign.b2bportal", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
...
if($bRus || COption::GetOptionString("redsign.b2bportal", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	if ($shopLocalization == "ru")
	{
		...
		COption::SetOptionString("redsign.b2bportal", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName");
		COption::SetOptionString("redsign.b2bportal", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr");
		COption::SetOptionString("redsign.b2bportal", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);

		$shopINN = $wizard->GetVar("shopINN");
		COption::SetOptionString("redsign.b2bportal", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("redsign.b2bportal", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("redsign.b2bportal", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("redsign.b2bportal", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("redsign.b2bportal", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("redsign.b2bportal", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		$siteStamp = $wizard->GetVar("siteStamp");
		if ($siteStamp == "")
			$siteStamp = COption::GetOptionString("redsign.b2bportal", "siteStamp", "", WIZARD_SITE_ID);
	}
	elseif ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("redsign.b2bportal", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName_ua");
		COption::SetOptionString("redsign.b2bportal", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr_ua");
		COption::SetOptionString("redsign.b2bportal", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID);

		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("redsign.b2bportal", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("redsign.b2bportal", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("redsign.b2bportal", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("redsign.b2bportal", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("redsign.b2bportal", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("redsign.b2bportal", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("redsign.b2bportal", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("redsign.b2bportal", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("redsign.b2bportal", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}

	$siteTelephone = $wizard->GetVar("siteTelephone");
	COption::SetOptionString("redsign.b2bportal", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("redsign.b2bportal", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	$siteName = $wizard->GetVar("siteName");
	COption::SetOptionString("redsign.b2bportal", "siteName", $siteName, false, WIZARD_SITE_ID);
	...
	if($siteStamp <> '')
	{
		if(intval($siteStamp) > 0)
		{
			...
			if($zr = $ff->Fetch())
			{
				...
				COption::SetOptionString("redsign.b2bportal", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
			}
		}
	}
	else
	...
	COption::SetOptionString("redsign.b2bportal", "personTypeFiz", $personTypeFiz, false, WIZARD_SITE_ID);
	$personTypeUr = (isset($personType["ur"]) && $personType["ur"] == "Y" ? "Y" : "N");
	COption::SetOptionString("redsign.b2bportal", "personTypeUr", $personTypeUr, false, WIZARD_SITE_ID);
	...
	if ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("redsign.b2bportal", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID);
			...
			if(\Bitrix\Main\Config\Option::get('sale', 'sale_locationpro_migrated', '') == 'Y')
			{
				if($shopLocation <> '')
				{
					...
					else
					{
						...
						/** @var array $LOCALIZATION_COUNTRY_CODE_MAP */
...
//Ukraine
	...
	foreach($arPaySystems as $arPaySystem)
	{
		...
		if (!$tmpPaySystem)
		{
			...
			if ($resultAdd->isSuccess())
			{
				...
				{
					/** @var array{LOGOTIP: array} $updateFields */
	...
	if (COption::GetOptionString("redsign.b2bportal", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
	{
		...
		/**
		 * @param array $arData
		 * @param array $productFilter
		 * @param int $prdCnt
		 * @return int|false
		 */
		$fnMakeOrder = function (array $arData, array $productFilter, int $prdCnt = 1) {
		...
		$orderID = $fnMakeOrder($arData, $productFilter, 3);
		if ($orderID)
		{
		...
		$orderID = $fnMakeOrder($arData, $productFilter, 4);
		if ($orderID)
		{
			CSaleOrder::DeliverOrder($orderID, "Y");
			CSaleOrder::PayOrder($orderID, "Y");
		...
		$orderID = $fnMakeOrder($arData, $productFilter, 2);
		if ($orderID)
		{
			CSaleOrder::PayOrder($orderID, "Y");
			CSaleOrder::StatusOrder($orderID, "P");
		}
		$orderID = $fnMakeOrder($arData, $productFilter, 1);
		$orderID = $fnMakeOrder($arData, $productFilter, 1);
		if ($orderID)
		{
