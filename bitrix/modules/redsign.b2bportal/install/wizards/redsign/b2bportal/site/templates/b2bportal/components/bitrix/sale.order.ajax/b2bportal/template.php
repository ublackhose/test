...
$asset->addCss('/bitrix/css/main/themes/' . $arParams['TEMPLATE_THEME'] . '/style.css', true);
$asset->addCss($templateFolder . '/style.css', true);
	...
	<div id="bx-soa-soc-auth-services" style="display:none">
		...
		if (Main\Loader::includeModule('socialservices') && $arResult['ALLOW_SOCSERV_AUTHORIZATION'] === 'Y')
		{
			...
			$arServices = $oAuthManager->GetActiveAuthServices(array(
				'BACKURL' => $component->arParams['~CURRENT_PAGE'],
