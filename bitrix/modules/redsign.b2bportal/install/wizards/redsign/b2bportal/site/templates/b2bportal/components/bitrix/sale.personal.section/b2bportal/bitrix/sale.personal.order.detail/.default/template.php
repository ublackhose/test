							...
							<div class="row">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										...
										if ($arParams['USE_CLAIMS'] == 'Y')
										{
											?>
											<a href="<?=$arResult["CLAIMS_PATH"]?>" class="sale-order-detail-about-order-inner-container-repeat-cancel">
												<?=Loc::getMessage('SPOD_LIST_CLAIMS');?>
											</a>
											<a href="<?=$arResult["ADD_CLAIM_PATH"]?>" class="sale-order-detail-about-order-inner-container-repeat-cancel">
												<?=Loc::getMessage('SPOD_NEW_CLAIM');?>
											</a>
											<?
										}
										?>
