...
if ($arParams['SHOW_ORDER_PAGE'] === 'Y')
{
	$availablePages[] = array(
		...
		"icon" => '<i class="flaticon2-list-3"></i>'
	);
}
...
if ($arParams['SHOW_PROFILE_PAGE'] === 'Y')
{
	$availablePages[] = array(
		...
		"icon" => '<i class="flaticon2-group"></i>'
	);
}
...
if ($arParams['SHOW_BASKET_PAGE'] === 'Y')
{
	$availablePages[] = array(
		...
		"icon" => '<i class="flaticon2-shopping-cart-1"></i>'
	);
}
...
if ($arParams['SHOW_CONTACT_PAGE'] === 'Y')
{
	$availablePages[] = array(
		...
		"icon" => '<i class="flaticon2-location"></i>'
	);
}
...
if ($customPagesList)
{
	...
	{
		if (
			strpos($page[0], 'personal/claims/') === false ||
			(strpos($page[0], 'personal/claims/') !== false && IsModuleInstalled('support'))
		)
		{
			$availablePages[] = array(
				"path" => $page[0],
