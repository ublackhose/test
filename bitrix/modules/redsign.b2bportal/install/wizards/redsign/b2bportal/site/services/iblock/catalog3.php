...
//precet
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/catalog/.asidesub.menu_ext.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/_index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/include/quicksearch.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/personal/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/personal/cart/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/personal/cart/pdf.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
