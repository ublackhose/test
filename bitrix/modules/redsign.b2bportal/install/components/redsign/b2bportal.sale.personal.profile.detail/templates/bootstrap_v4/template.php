	...
	<div class="row mb-3">
		<form method="post" class="col sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
						...
						?>
							...
							elseif ($property["TYPE"] == "SELECT")
							{
								...
								<div class="form-group row mb-2">
									...
									<div class="col-sm-9">
										<select class="form-control mb-1" name="<?=$name?>" id="sppd-property-<?=$key?>" size="<?=(intval($property["SIZE1"]) > 0) ? $property["SIZE1"] : 1; ?>">
											<?
							...
							elseif ($property["TYPE"] == "MULTISELECT")
							{
								...
								<div class="form-group row mb-2">
									...
									<div class="col-sm-9">
										<select class="form-control mb-1" id="sppd-property-<?=$key?>" multiple name="<?=$name?>[]" size="<?=(intval($property["SIZE1"]) > 0) ? $property["SIZE1"] : 5; ?>">
											<?
											$arCurVal = array();
			...
			<div class="row mb-3 mt-5">
				<div class="col">
					<input type="submit" class="btn btn-primary btn-md" name="save" value="<?=GetMessage("SALE_SAVE") ?>">
					<input type="submit" class="btn btn-primary btn-md" name="apply" value="<?=GetMessage("SALE_APPLY")?>">
					<input type="submit" class="btn btn-link btn-md" name="reset" value="<?=GetMessage("SALE_RESET")?>">
				</div>
			</div>
		</form>
	</div>
