...
JCSmartFilter.prototype.reload = function(input)
{
	...
	if (this.form)
	{
		...
		else
		{
			...
			console.log('this.postHandler', this.postHandler);
	...
	if (!!result && !!result.ITEMS)
	{
		...
		if (!!modef && !!modef_num)
		{
			...
			else
			{
				...
				if (result.SEF_SET_FILTER_URL || result.FILTER_AJAX_URL)
				{
					url = result.SEF_SET_FILTER_URL || BX.util.htmlspecialcharsback(result.FILTER_AJAX_URL);
					BX.onCustomEvent('filter-' + this.filterName + '-on-submit', [null, url])
...
JCSmartFilter.prototype.selectDropDownItem = function(element, controlId)
{
	...
	var wrapContainer = BX.findParent(BX(controlId), {className:"btn-group"}, false);
	// var wrapContainer = BX.findParent(BX(controlId), {className:"smart-filter-input-group-dropdown"}, false);

	var currentOption = wrapContainer.querySelector('[data-role="currentOption"]');
	currentOption.innerHTML = element.innerText;
