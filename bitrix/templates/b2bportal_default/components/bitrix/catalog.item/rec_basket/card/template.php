 ...
 */
?>
<div class="catalog_section_lJE12_block">
<div class="vgt-wrap">
    <table class="vgt-table bordered ">
        <thead>
        <tr>

            <th class="text-nowrap vgt-left-align can-sorting" style="min-width: auto; width: auto;">
                <span>Название</span></th>
            <th class="text-nowrap vgt-left-align" style="min-width: auto; width: auto;">
                <span
                >Наличие</span></th>
            <th class="text-nowrap vgt-left-align can-sorting sorting sorting-desc"
                style="min-width: auto; width: auto;"><span>Розничная цена</span></th>
        ...
        <tbody>
        <tr class="" id="bx_3223398850_17011">
            ...
            <td class="vgt-left-align" data-entity="price-block">
                <div>
                    <div class="d-flex">
                        <div class="d-block">
                            <div class="mb-2"><span class="mr-2"><a href="<?= $item['DETAIL_PAGE_URL'] ?>"><?= $productTitle ?></a></span>
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <span>
                    <span>
                        <a href="#" class="d-inline-block">
                            <span class="kt-badge kt-badge--inline kt-badge--pill text-nowrap kt-badge--warning">99 шт
                            </span>
                        </a>
                        <span style="display: none;"><span class="d-block">
                                <span class="d-block">
                                    <span class="d-block">складов не найдено
                                    </span>
                                </span>
                            </span>
                        </span>
            ...
            <td class="vgt-left-align">
                <div><span class="text-nowrap" id="<?= $itemIds['PRICE'] ?>"><?echo $price['PRINT_RATIO_PRICE'];?></span></div>
            </td>
            <td class="vgt-left-align text-center" data-entity="buttons-block">
                <div class="product-item-button-container pt-4">
                    <button class="btn btn-primary btn-sm" onclick = "addBasket(<?=$item['ID']?>,'<?=$item['NAME']?>')" href="javascript:void(0)" rel="nofollow" id="<?= $itemIds['BUY_LINK'] ?>"><i class="flaticon2-shopping-cart-1 pr-0"></i></button>
                </div>
            </td>
        </tr>
        </tbody>
