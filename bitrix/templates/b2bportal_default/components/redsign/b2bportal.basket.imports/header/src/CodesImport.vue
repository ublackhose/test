<template>
	<div>
		<code 
			...
			:data-placeholder="messages.HEADER_RS_B2BPORTAL_BI_CATALOG_PLACEHOLDER"
			@input="handleInput"
			@blur="handleBlur"
		...
		<div class="mt-4 pull-right">
			<button type="button" class="btn btn-outline-brand" data-dismiss="modal">{{ messages.HEADER_RS_B2BPORTAL_BI_MODAL_CANCEL }}</button>
			<button type="button" class="btn btn-primary" @click="addtobasket">{{ messages.HEADER_RS_B2BPORTAL_BI_MODAL_IMPORT }} </button>
		</div>
	</div>
</template>
