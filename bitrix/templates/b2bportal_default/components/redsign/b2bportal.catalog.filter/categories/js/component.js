...
(function (exports) {
	...
	var CSLTree = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(CSLTree, [{
	    ...
	    value: function init() {
	      var _this = this;
	      var onChangedHandle = BX.debounce(function (e, _ref) {
	        var selected = _ref.selected;
	        _this.onSelectedHandle(selected);
	      }, 1000);
	      $(this.treeNode).jstree({
	        ...
	        setTimeout(function () {
	          $(_this.treeNode).on('changed.jstree', onChangedHandle);
	        });
	      });
	    }
	  }, {
	    ...
	    key: "sendRequest",
	    value: function () {
	      var _sendRequest = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(filterCategories) {
	        var uri;
