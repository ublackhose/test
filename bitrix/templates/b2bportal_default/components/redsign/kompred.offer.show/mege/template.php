			...
			switch($type)
			{
				...
				case 'productTable':
					?><table class="rskp-pdf-pt">
						<thead>
							<tr>
								<th class="rskp-pdf-pt__col rskp-pdf-pt__col--index">
									<?=Loc::getMessage('RS_KP_KOS_T_DEFAULT_COL_INDEX')?>
								</th>
								<th class="rskp-pdf-pt__col rskp-pdf-pt__col--code">
									<?=Loc::getMessage('RS_KP_KOS_T_DEFAULT_VENDOR_CODE')?>
								</th>
						...
						<tbody>
							<?php foreach ($arResult['OFFER']['PRODUCTS'] as $productData): ?>
								<tr>
									<td class="rskp-pdf-pt__col rskp-pdf-pt__col--index">
										<div class="rskp-pdf-pt__index">
											<?=$productData['INDEX']?>
										</div>
									</td>
									<td class="rskp-pdf-pt__col rskp-pdf-pt__col--code">
									...
									<td class="rskp-pdf-pt__col rskp-pdf-pt__col--sum">
										<span><?=$productData['SUM_PRICE_FORMATTED']?></span>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
						<tfoot>
							<tr>
								<td colspan="5" class="rskp-pdf-pt__col rskp-pdf-pt__col--total">
