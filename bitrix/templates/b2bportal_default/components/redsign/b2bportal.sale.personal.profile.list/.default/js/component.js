...
(function (exports) {
	  ...
	  return _c("vue-table", {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function fn(props) {
	        return [props.column.field == "NAME" ? [_c("a", {
	        ...
	        }, [_vm._v(_vm._s(_vm.messages.REMOVE))])])]), _vm._v(" "), _c("li", {
	          staticClass: "kt-nav__item"
	        }, [_c("a", {
	          staticClass: "kt-nav__link",
	          attrs: {
	          ...
	          staticClass: "kt-nav__link-text"
	        }, [_vm._v(_vm._s(_vm.messages.COPY))])])])])])])] : [_vm._v("\n\t\t\t" + _vm._s(props.formattedRow[props.column.field]) + "\n\t\t")]];
	      }
	    }])
	  });
	};
	...
	var SalePersonalProfileListTable = /*#__PURE__*/function (_B2BPortal$Components) {
	  babelHelpers.inherits(SalePersonalProfileListTable, _B2BPortal$Components);
	  function SalePersonalProfileListTable(data, params) {
	    var _this;
	    babelHelpers.classCallCheck(this, SalePersonalProfileListTable);
	    _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SalePersonalProfileListTable).call(this, data, params));
	    _this.init();
	    return _this;
	  }
	  babelHelpers.createClass(SalePersonalProfileListTable, [{
	    ...
	    value: function attachTemplateTable() {
	      ...
	      this.vueTable = new Vue({
	        ...
	        components: {
	          VuePersonalProfileTable: __vue_component__
	        },
	  ...
	  return SalePersonalProfileListTable;
	}(B2BPortal.Components.Table);

	exports.SalePersonalProfileListTable = SalePersonalProfileListTable;
